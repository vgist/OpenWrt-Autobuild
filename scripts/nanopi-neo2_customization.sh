...
# cpufreq
cp -f ../patches/103-sun50i-h5-add-cpu-opp-refs.patch target/linux/sunxi/patches-5.10/
cp -f ../patches/302-sun50i-h5-add-more-cpu-operating-points.patch target/linux/sunxi/patches-5.10/
