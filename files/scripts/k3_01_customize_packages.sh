...
# k3 screen
git clone https://github.com/lwz322/luci-app-k3screenctrl package/k3/luci-app-k3screenctrl
git clone https://github.com/lwz322/k3screenctrl_build package/k3/k3screenctrl_build
...
git clone -b master --single-branch https://github.com/kuoruan/luci-app-frpc.git
git clone -b master --single-branch https://github.com/lwz322/luci-app-frps.git
