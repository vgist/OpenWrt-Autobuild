...
# swith patch to current firewall4 version
wget -q -NP package/network/config/firewall4/patches https://github.com/immortalwrt/immortalwrt/raw/ce3b9cc717/package/network/config/firewall4/patches/001-firewall4-add-support-for-fullcone-nat.patch
